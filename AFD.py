...
def convertToAFD(file):
        ...
        for i in alphabet:
            ...
            if len(subset) != 0:
                ...
                if temp_state != 'Q1':
                    ...
                    transitionB.append(("Q"+str(states.index(temp_state)+1), i, "Q"+str(states.index(subset)+1)))
                else:
                    transition.append((temp_state, i, subset))
                    transitionB.append(("Q"+str(states.index([temp_state])+1), i, "Q"+str(states.index(subset)+1)))
    ...
    afd['start_stateB'] = file['start_states']
    afd['statesB'] = ["Q"+str(states.index(i)+1) for i in states]
    afd['final_statesB'] = ["Q"+str(states.index(i)+1) for i in finalStates]
